...
use self::stdweb::{Value, JsSerialize};
...
impl WebGL2RenderingContext
{
    ...
    pub fn compressed_tex_image2d(&self, target: GLenum, level: GLint, internalformat: GLenum, width: GLsizei, height: GLsizei, border: GLint, image_size: GLsizei, offset: GLintptr) {
        js!( @{self}.compressedTexImage2D(@{target}, @{level}, @{internalformat}, @{width}, @{height}, @{border}, @{image_size}, @{offset as f64}); );
    }

    pub fn compressed_tex_image2d_1(&self, target: GLenum, level: GLint, internalformat: GLenum, width: GLsizei, height: GLsizei, border: GLint, src_data: &ArrayBuffer, src_offset: GLuint, src_length_override: GLuint) {
        js!( @{self}.compressedTexImage2D(@{target}, @{level}, @{internalformat}, @{width}, @{height}, @{border}, @{src_data}, @{src_offset}, @{src_length_override}); );
    }

    pub fn compressed_tex_image2d_2(&self, target: GLenum, level: GLint, internalformat: GLenum, width: GLsizei, height: GLsizei, border: GLint, data: &ArrayBuffer) {
    ...
    pub fn copy_tex_image2d(&self, target: GLenum, level: GLint, internalformat: GLenum, x: GLint, y: GLint, width: GLsizei, height: GLsizei, border: GLint) {
    ...
    pub fn get_program_info_log(&self, program: &WebGLProgram) -> Result<(),String> {
        if !(self.get_program_parameter(program, Self::LINK_STATUS)) {
            Err((js! { return @{self}.getProgramInfoLog(@{program}); } ).try_into().ok().unwrap())
        } else {
            Ok(())
        }
    }

    pub fn get_program_parameter(&self, program: &WebGLProgram, pname: GLenum) -> bool {
    ...
    pub fn get_shader_info_log(&self, shader: &WebGLShader) -> Result<(),String> {
        if !(self.get_shader_parameter(shader, Self::COMPILE_STATUS)) {
            Err((js! { return @{self}.getShaderInfoLog(@{shader}); } ).try_into().ok().unwrap())
        } else {
            Ok(())
        }
    }

    pub fn get_shader_parameter(&self, shader: &WebGLShader, pname: GLenum) -> bool {
    ...
    pub fn tex_image2d(&self, target: GLenum, level: GLint, internalformat: GLint, width: GLsizei, height: GLsizei, border: GLint, format: GLenum, type_: GLenum, pixels: Option<&ArrayBuffer>) {
        js!( @{self}.texImage2D(@{target}, @{level}, @{internalformat}, @{width}, @{height}, @{border}, @{format}, @{type_}, @{pixels}); );
    }

    pub fn tex_image2d_1<T0>(&self, target: GLenum, level: GLint, internalformat: GLint, format: GLenum, type_: GLenum, source: T0) where T0: JsSerialize {
        js!( @{self}.texImage2D(@{target}, @{level}, @{internalformat}, @{format}, @{type_}, @{source}); );
    }

    pub fn tex_image2d_2(&self, target: GLenum, level: GLint, internalformat: GLint, width: GLsizei, height: GLsizei, border: GLint, format: GLenum, type_: GLenum, pbo_offset: GLintptr) {
        js!( @{self}.texImage2D(@{target}, @{level}, @{internalformat}, @{width}, @{height}, @{border}, @{format}, @{type_}, @{pbo_offset as f64}); );
    }

    pub fn tex_image2d_3<T0>(&self, target: GLenum, level: GLint, internalformat: GLint, width: GLsizei, height: GLsizei, border: GLint, format: GLenum, type_: GLenum, source: T0) where T0: JsSerialize {
        js!( @{self}.texImage2D(@{target}, @{level}, @{internalformat}, @{width}, @{height}, @{border}, @{format}, @{type_}, @{source}); );
    }

    pub fn tex_image2d_4(&self, target: GLenum, level: GLint, internalformat: GLint, width: GLsizei, height: GLsizei, border: GLint, format: GLenum, type_: GLenum, src_data: &ArrayBuffer, src_offset: GLuint) {
...
{   
    ...
    pub fn bind_framebuffer(&self, target: GLenum, framebuffer:&WebGLFramebuffer) {
        js!( @{self}.bindFramebuffer(@{target}, @{framebuffer}); );
    }

    pub fn bind_renderbuffer(&self, target: GLenum, renderbuffer:&WebGLRenderbuffer) {
        js!( @{self}.bindRenderbuffer(@{target}, @{renderbuffer}); );
    }
    ...
    pub fn buffer_data<'a0, T0, T1>(&self, target: GLenum, data: T0, usage: GLenum) where T0: AsTypedArray<'a0, T1> {
        js!( @{self}.bufferData(@{target}, @{unsafe { data.as_typed_array() }}, @{usage}); );
    }

    pub fn buffer_data_0(&self, target: GLenum, size: GLsizeiptr, usage: GLenum) {
        js!( @{self}.bufferData(@{target}, @{size as f64}, @{usage}); );
    }
    ...
    pub fn buffer_sub_data<'a0, T0, T1>(&self, target: GLenum, offset: GLintptr, data: T0) where T0: AsTypedArray<'a0, T1> {
        js!( @{self}.bufferSubData(@{target}, @{offset as f64}, @{unsafe { data.as_typed_array() }}); );
    }

    pub fn buffer_sub_data_1(&self, target: GLenum, offset: GLintptr, data: &ArrayBuffer) {
    ...
    pub fn compressed_tex_image2d(&self, target: GLenum, level: GLint, internalformat: GLenum, width: GLsizei, height: GLsizei, border: GLint, data: &ArrayBuffer) {
        js!( @{self}.compressedTexImage2D(@{target}, @{level}, @{internalformat}, @{width}, @{height}, @{border}, @{data}); );
    }
    ...
    pub fn tex_image2d<'a0, T0>(&self, target: GLenum, level: GLint, internalformat: GLenum, width: GLsizei, height: GLsizei, border: GLint, format: GLenum, type_: GLenum, pixels: T0) where T0: AsTypedArray<'a0, u8> {
        js!( @{self}.texImage2D(@{target}, @{level}, @{internalformat}, @{width}, @{height}, @{border}, @{format}, @{type_}, @{unsafe { pixels.as_typed_array() }}); );
    }

    pub fn tex_image2d_1<T0>(&self, target: GLenum, level: GLint, internalformat: GLenum, format: GLenum, type_: GLenum, source: T0) where T0: JsSerialize {
        js!( @{self}.texImage2D(@{target}, @{level}, @{internalformat}, @{format}, @{type_}, @{source}); );
    }
    ...
    pub fn tex_sub_image2_d<'a0, T0>(&self, target: GLenum, level: GLint, xoffset: GLint, yoffset: GLint, width: GLsizei, height: GLsizei, format: GLenum, type_: GLenum, pixels: T0) where T0: AsTypedArray<'a0, u8> {
        js!( @{self}.texSubImage2D(@{target}, @{level}, @{xoffset}, @{yoffset}, @{width}, @{height}, @{format}, @{type_}, @{unsafe { pixels.as_typed_array() }}); );
    }
    ...
    pub fn uniform2fv(&self, location: Option<&WebGLUniformLocation>, value: (f32, f32)) {
        js!( @{self}.uniform2f(@{location}, @{value.0}, @{value.1}); );
    }
    ...
    pub fn uniform2iv(&self, location: Option<&WebGLUniformLocation>, value: (i32, i32)) {
        js!( @{self}.uniform2i(@{location}, @{value.0}, @{value.1}); );
    }
    ...
    pub fn uniform3fv(&self, location: Option<&WebGLUniformLocation>, value: (f32, f32, f32)) {
        js!( @{self}.uniform3f(@{location}, @{value.0}, @{value.1}, @{value.2}); );
    }
    ...
    pub fn uniform3iv(&self, location: Option<&WebGLUniformLocation>, value: (i32, i32, i32)) {
        js!( @{self}.uniform3i(@{location}, @{value.0}, @{value.1}, @{value.2}); );
    }
    ...
    pub fn uniform4fv(&self, location: Option<&WebGLUniformLocation>, value: (f32, f32, f32, f32)) {
        js!( @{self}.uniform4f(@{location}, @{value.0}, @{value.1}, @{value.2}, @{value.3}); );
    }
    ...
    pub fn uniform4iv(&self, location: Option<&WebGLUniformLocation>, value: (i32, i32, i32, i32)) {
        js!( @{self}.uniform4i(@{location}, @{value.0}, @{value.1}, @{value.2}, @{value.3}); );
    }
